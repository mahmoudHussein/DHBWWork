...
/** this class is the fifth version of the project code, this class alows the user to input an xml file of any process diagram
 * and then the elements in this file is extracted and then converted into a token form that can be used on the CPN tool.
 * 
 * @author mahmoud
 *
 */
